...
class Jugador:
    ...
    def juega_carta(self) -> CartaPoker:
        ...
        """
        carta= self.__cartas.sacar_carta()
    ...
    def toma_carta(self, carta:CartaPoker) -> None:
        ...
        Returns:
            Nada.
        """
        self.__cartas.poner_carta(carta)
    ...
    def toma_pozo(self, pozo: MazoPoker) -> MazoPoker:
        ...
        for i in range(pozo.__len__()):
            self.__cartas.poner_carta(pozo.sacar_carta())
        return pozo

    def __str__(self) -> str:
        return f"Cartas {self.__nombre} ==> {str(self.__cartas)}"
...
class BatallaCartas:
    ...
    def __repartir_mazo(self, jug1: Jugador, jug2: Jugador) -> None:
        ...
        while not mazo.isvacio():
            jug1.toma_carta(mazo.sacar_carta())
            jug2.toma_carta(mazo.sacar_carta())
